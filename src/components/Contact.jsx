...
const container = `bg-gradient-to-b from-slate-950 to-slate-900 text-gray-200 py-20 px-5 md:px-10`;
...
function Contact() {
  const handleSubmit = (e) => {
    ...
    const mailtoLink = `mailto:anuragaffection.contact@gmail.com?subject=Message%20from%20${encodeURIComponent(name)}&body=${encodeURIComponent(message)}`;
      ...
      <div name='contact' className={container}>
        <div className={wrapper}>
          ...
          <form action='' method='POST' className={contactForm} onSubmit={handleSubmit}>
            ...
            <textarea className={inputStyleTextArea} name='message' rows={4} placeholder='Message' required></textarea>
