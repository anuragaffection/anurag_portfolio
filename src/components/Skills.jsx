...
const container = `bg-gray-900 text-gray-200`;
const wrapper = `flex flex-col justify-center items-center p-4 gap-4`;
const skillContainer = 'flex flex-col bg-dark p-3 md:grid md:gap-2 grid-cols-2 grid-rows-auto' ;
const skillStyle = 'flex flex-col justify-center items-center bg-gray-950 p-3 m-3 rounded-xl';
