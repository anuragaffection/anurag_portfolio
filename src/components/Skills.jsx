...
const container = `bg-gradient-to-t from-slate-950 to-slate-900 text-gray-100`;
...
const skillTitle = 'text-amber-600 text-xl font-semibold text-center my-3';
const skillList = 'flex flex-wrap gap-3 justify-center items-center px-3 py-4';
const oneSkillStyle = 'flex items-center p-2 border-2 border-gray-700 rounded-xl gap-2';
