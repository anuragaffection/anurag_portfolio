...
const wrapper = `flex flex-col justify-center items-center py-20 md:py-16 px-4 md:px-10 md:py-10 gap-4`;
const title = 'text-4xl font-bold text-amber-500';
const desc = 'text-xl text-center';
const skillContainer = 'flex flex-col p-1 lg:p-3 gap-6 gap-x-8 md:grid grid-cols-2 grid-rows-auto';
