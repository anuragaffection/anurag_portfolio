...
const contactForm = `flex flex-col gap-6 bg-gray-950 p-5 rounded-lg w-full md:w-2/3 lg:w-1/2`;
...
function Contact() {
  const handleSubmit = (e) => {
    ...
    const mailtoLink = `mailto:${Bio.contactEmail}?subject=Message%20from%20${encodeURIComponent(name)}&body=${encodeURIComponent(message)}`;
